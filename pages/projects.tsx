  ...
  return (
    <div id="projects" className="mt-20" data-aos="fade-right">
      ...
      <div id="title" className="relative">
        <h2 className="text-5xl ml-9 absolute pointer-events-none left-24 -top-4 z-0 -translate-x-1/2 transform font-bold uppercase text-heading opacity-15 text-white opacity-20">Projects</h2>
